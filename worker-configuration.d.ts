/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39a2045de2e3aeaba0cc9f07f3810e1b)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PatchSession" | "Registry";
	}
	interface Env {
		ASSETS: Fetcher;
		PATCH_SESSION: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").PatchSession>;
		REGISTRY: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").Registry>;
	}
}
